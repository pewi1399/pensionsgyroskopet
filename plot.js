...
*/
    ...
    if(s3.value() < Number($('input[name^="f2"]').val()) * 0.18){
      ...
      d3.select(".incometext").text("Bruttoinkomst idag. Valt sparande understiger den för nuvarande obligatoriska avgiften").style("fill", "red")
    }else{
